...
ignored_files=(".svelte-kit" ".idea" ".DS_Store" "secrets.json" "README.md" "node_modules" "output.txt" "temp.txt" "tree_script.sh" "package-lock.json" "ignored_files" ".git" ".env" ".gitignore")
